...
const CrawlerLivePage = () => {
  ...
  useEffect(() => {
    const hubConnection = new HubConnectionBuilder()
      .withUrl(`${VITE_SIGNALR_URL}/Hubs/CrawlerLogHub`)
      .withAutomaticReconnect()
      .build();

    hubConnection.on('NewCrawlerLogAdded', (crawlerLogDto) => {
      dispatch(addLog(crawlerLogDto));
    });
  ...
  return (
    <Container>
      ...
      <div className="fakeScreen">
        {logs.map((log: CrawlerLogDto, index: number) => (
